...
import { de_ModifyCurrentDBClusterCapacityCommand, se_ModifyCurrentDBClusterCapacityCommand, } from "../protocols/Aws_query";
export { $Command };
export class ModifyCurrentDBClusterCapacityCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ModifyCurrentDBClusterCapacityCommand.getEndpointParameterInstructions()));
