...
class CopyDBSnapshotCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, CopyDBSnapshotCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_query_1.se_CopyDBSnapshotCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_query_1.de_CopyDBSnapshotCommand)(output, context);
    }
}
