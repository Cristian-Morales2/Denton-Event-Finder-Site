import { AmazonProviderProps, AppleProviderProps, AuthProps, ExternalProviderOptions, FacebookProviderProps, GoogleProviderProps, OidcProviderProps } from '@aws-amplify/auth-construct';
import { BackendSecret, ConstructFactory, ConstructFactoryGetInstanceProps, ResourceAccessAcceptor, ResourceAccessAcceptorFactory, ResourceProvider } from '@aws-amplify/plugin-types';
/**
