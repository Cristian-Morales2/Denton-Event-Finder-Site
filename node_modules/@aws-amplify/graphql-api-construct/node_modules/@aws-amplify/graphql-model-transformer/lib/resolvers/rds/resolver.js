...
const createRdsLambda = (scope, apiGraphql, lambdaRole, layerVersionArn, resourceNames, credentialStorageMethod, environment, sqlLambdaVpcConfig, sqlLambdaProvisionedConcurrencyConfig) => {
    ...
    if (credentialStorageMethod === CredentialStorageMethod.SSM) {
        ...
        if (sqlLambdaVpcConfig) {
            ...
            if (endpointEntries) {
                ssmEndpoint = aws_cdk_lib_1.Fn.select(0, endpointEntries);
            }
        }
        ...
        if (sqlLambdaVpcConfig) {
            ...
            const endpoints = addVpcEndpoints(scope, sqlLambdaVpcConfig, resourceNames, services);
            const endpointEntries = (_b = endpoints.find((endpoint) => endpoint.service === 'secretsmanager')) === null || _b === void 0 ? void 0 : _b.endpoint.attrDnsEntries;
            if (endpointEntries) {
...
const createRdsLambdaRole = (roleName, scope, secretEntry, resourceNames) => {
...
const generateLambdaRequestTemplate = (tableName, operation, operationName, ctx) => {
    ...
    return (0, graphql_mapping_template_1.printBlock)('Invoke RDS Lambda data source')((0, graphql_mapping_template_1.compoundExpression)([
        ...
        (0, graphql_transformer_core_1.constructAuthFilterStatement)('lambdaInput.args.metadata.authFilter'),
