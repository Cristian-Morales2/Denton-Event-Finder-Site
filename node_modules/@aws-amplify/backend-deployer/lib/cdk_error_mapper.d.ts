...
export type CDKDeploymentError = 'AccessDeniedError' | 'BackendBuildError' | 'BackendSynthError' | 'BootstrapNotDetectedError' | 'CDKResolveAWSAccountError' | 'CFNUpdateNotSupportedError' | 'CloudFormationDeploymentError' | 'FilePermissionsError' | 'MultipleSandboxInstancesError' | 'ESBuildError' | 'ExpiredTokenError' | 'FileConventionError' | 'FileConventionError' | 'ModuleNotFoundError' | 'SecretNotSetError' | 'SyntaxError';
