import { BackendDeployer, DeployProps, DeployResult, DestroyResult } from './cdk_deployer_singleton_factory.js';
...
export declare class CDKDeployer implements BackendDeployer {
     ...
     */
    destroy: (backendId: BackendIdentifier) => Promise<DeployResult | DestroyResult>;
    /**
