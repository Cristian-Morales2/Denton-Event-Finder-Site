...
import { StandardAttributes, UserPoolIdentityProviderSamlMetadata } from 'aws-cdk-lib/aws-cognito';
 ...
 * Google provider.
 */
export type GoogleProviderProps = Omit<cognito.UserPoolIdentityProviderGoogleProps, 'userPool' | 'clientSecretValue' | 'clientSecret' | 'attributeMapping'> & {
    /**
 ...
 * Apple provider.
 */
export type AppleProviderProps = Omit<cognito.UserPoolIdentityProviderAppleProps, 'userPool' | 'attributeMapping'> & IdentityProviderProps;
/**
 * Amazon provider.
 */
export type AmazonProviderProps = Omit<cognito.UserPoolIdentityProviderAmazonProps, 'userPool' | 'attributeMapping'> & IdentityProviderProps;
/**
 * Facebook provider.
 */
export type FacebookProviderProps = Omit<cognito.UserPoolIdentityProviderFacebookProps, 'userPool' | 'attributeMapping'> & IdentityProviderProps;
/**
 * OIDC provider.
 */
export type OidcProviderProps = Omit<cognito.UserPoolIdentityProviderOidcProps, 'userPool' | 'attributeRequestMethod' | 'attributeMapping'> & {
    /**
 ...
 * SAML provider.
 */
export type SamlProviderProps = Omit<cognito.UserPoolIdentityProviderSamlProps, 'userPool' | 'metadata' | 'attributeMapping'> & {
    /**
     * The SAML metadata.
     */
