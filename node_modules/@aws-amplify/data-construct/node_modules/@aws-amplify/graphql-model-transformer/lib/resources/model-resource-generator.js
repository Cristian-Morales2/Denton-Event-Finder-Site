    ...
    constructor(options = {}) {
        ...
        this.generateUpdateResolver = (ctx, type, modelConfig, typeName, fieldName, resolverLogicalId) => {
            ...
            if (!this.resolverMap[resolverKey]) {
                ...
                resolver.addToSlot('init', graphql_transformer_core_1.MappingTemplate.s3MappingTemplateFromString(vtlGenerator.generateUpdateInitSlotTemplate(updateInitConfig), `${typeName}.${fieldName}.{slotName}.{slotIndex}.req.vtl`));
                this.resolverMap[resolverKey] = resolver;
            }
            return this.resolverMap[resolverKey];
        };
