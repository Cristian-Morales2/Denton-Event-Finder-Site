import { DerivedCombinedSchema, DerivedModelSchema } from '@aws-amplify/data-schema-types';
...
export type AmplifyDataError = 'DefineDataConfigurationError' | 'InvalidSchemaAuthError' | 'InvalidSchemaError' | 'MultipleSingletonResourcesError' | 'UnresolvedEntryPath';
